      ...
      <div class="container-fluid">
          <div class="row align-items-start">
            ...
            <div class="btn_col column col-lg-4 col-md-12 col-sm-12">
              <div class=" button">
              <a href="php files/login.php"><button class="header_btn signup-btn btn btn-primary" type="button" >LOGIN</button></a>

                <a href="php files/register.php"><button class="header_btn signup-btn btn btn-primary" type="button" >SIGNUP</button></a>
